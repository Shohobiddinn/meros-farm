...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SoldProductUpdate', function() {
      beforeEach(function() {
        instance = new MerosWebApp.SoldProductUpdate();
      });

      it('should create an instance of SoldProductUpdate', function() {
        // TODO: update the code to test SoldProductUpdate
        expect(instance).to.be.a(MerosWebApp.SoldProductUpdate);
      });
