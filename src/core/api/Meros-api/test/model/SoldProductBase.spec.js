...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SoldProductBase', function() {
      beforeEach(function() {
        instance = new MerosWebApp.SoldProductBase();
      });

      it('should create an instance of SoldProductBase', function() {
        // TODO: update the code to test SoldProductBase
        expect(instance).to.be.a(MerosWebApp.SoldProductBase);
      });
